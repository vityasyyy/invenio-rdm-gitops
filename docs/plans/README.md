...
| [2026-09-05-worker-02-rebalance.md](active/2026-09-05-worker-02-rebalance.md) | — | #74 | **Phase-2 IMPLEMENTED 2026-09-06 (`feat/74-limits-impl`, VPN up)** — all 16 v3 rows applied exactly (worker-02 → 68.9% req / 207.8% lim, worker-01 → 55.6%/146.2%; residual 620Mi over 200% cap explicitly accepted, Q1 squeezes not attempted) + Q4 dead-key fixes + scheduler render-identical + gitignore; helm-proven per key, kustomize+yamllint clean; pushed, no PR (lead integrates, Group 8 post-merge verification pending) |
