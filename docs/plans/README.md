...
| [2026-09-05-backup-scheduler-deadlock.md](active/2026-09-05-backup-scheduler-deadlock.md) | — | #81 | **Diagnosed + unblock EXECUTED 2026-09-05** — scheduler was frozen since 2026-08-21 (`already exists` on `postgres-daily-backup-20260821030200`), 1,872 failed / 0 completed. Blocking object deleted (approved, snapshotted), manual backup **completed**, LastBackupSucceeded True. Scheduler timestamp advance pending next loop confirmation |
