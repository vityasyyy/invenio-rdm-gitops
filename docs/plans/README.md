...
|---|---|---|---|
| [2026-09-08-monitoring-overhaul.md](active/2026-09-08-monitoring-overhaul.md) | — | — | **DESIGN APPROVED 2026-09-08** — T2: one `InvenioRDM` Grafana folder (`00 Overview` + 3 drill-downs), A–E alert rewrite with runbook/dashboard annotations, pinned Discord bridge + ServiceMonitor + PostSync pipecheck, `promtool` + dashboard-lint CI job. Awaiting user spec review before implementation planning |
