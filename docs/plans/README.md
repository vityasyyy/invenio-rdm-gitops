...
| [2026-09-05-worker-02-rebalance.md](active/2026-09-05-worker-02-rebalance.md) | — | #74 | **Phase-2 DECIDED 2026-09-06 (#88, Option 1)** — worker proved invenio-only cuts futile (best 77%/328%); cluster-wide limits cuts with recorded bounds+guardrails pending worker wave |
