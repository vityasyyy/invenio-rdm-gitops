...
- MinIO usage: the generator reuses the shared MinIO credential pair for Velero and Invenio by default; narrow it later with dedicated S3 creds if you add a MinIO user/policy flow.
